package com.liu.serviceaggr.control.impl;
...
import com.liu.serviceaggr.util.ControlConstants;
import com.liu.serviceaggr.util.ServiceCoreException;	
	...
	public OutputDTO execute(InputDTO inputDTO) {
		...
		try {
			...
			if (inputDTO != null) {//2:逻辑严谨性
				...
				throw new ServiceCoreException("InputDTO can't be null !!!");
			}
